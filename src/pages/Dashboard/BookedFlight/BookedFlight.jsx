          ...
          <tbody>
            ...
            </tr>
            {
              bookedFlight.map((flight, id) => <tr key={id}>
                ...
                <td className="h-12 px-6 text-sm transition duration-300 border-t border-l first:border-l-0 border-slate-200 stroke-slate-500 text-black">{flight?.flight?.Airline}</td>
