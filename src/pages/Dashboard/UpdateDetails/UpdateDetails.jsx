...
const UpdateDetails = () => {
    ...
    const { _id: id, Airline, Flight_Name, From, To, Departure_Time, Arrival_Time, Total_Time, Total_Stops, Fare } = flight
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const flightDetails = { id, Airline, image, From, To, Departure_Time, Arrival_Time, Total_Time, Total_Stops, Fare }
                ...
                <form onSubmit={handleSubmit} className="border p-5 rounded-xl">
                    ...
                    <div className="flex gap-5 justify-between">
                        ...
                        <div className="flex flex-col w-1/2">
                            ...
                            <input defaultValue={Flight_Name} className="p-3 outline-none border rounded-xl text-red-400 font-bold" type="text" name="total_fare" id="" />
                        </div>
                    </div>
